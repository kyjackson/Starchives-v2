...
/**
 * Wraps the original JS code in a function that can be called each time the page loads, as a workaround for Blazor's single-page application model.
 */
function initializeHomePage() {
	...
	/**
	 * Uses an ajax request to get search results one page at a time.
	 */
	...
	/**
	 * Uses an ajax request to get the number of results separately from the actual search results to improve response time.
	 */
	...
	/**
	 * Displays all the videos for a specified page.
	 */
	...
	/**
	 * Disables the button that navigates to the previous page of search results.
	 */
	...
	/**
	 * Disables the button that navigates to the next page of search results.
	 */
